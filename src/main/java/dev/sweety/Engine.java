...
public final class Engine implements Calculator, AutoCloseable {
    ...
    public Engine() { handle = create(); }

    @Override public int sum(int a, int b) { return sum(handle, a, b); }
    @Override public int subtract(int a, int b) { return subtract(handle, a, b); }
