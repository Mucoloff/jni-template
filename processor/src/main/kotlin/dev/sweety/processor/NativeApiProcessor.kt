...
class NativeApiProcessor(
    ...
    private fun handle(iface: KSClassDeclaration) {
        ...
        // Segment-level surface both bindings share: every method present on both backends.
        val both = methods.filter { it.jni != null && it.cabi != null }
    ...
    private fun writeFfmBindings(pkg: String, ffm: List<Method>) = write(
    ...
    companion object {
        ...
        private val JNI_BINDINGS = """
            ...
            public final class JniBindings implements Bindings {
        ...
        private val FFM_BINDINGS = """
            ...
            public final class FfmBindings implements Bindings {
        ...
        private val BINDINGS_IFACE = """
            ...
            public interface Bindings {
                static Bindings of(Binding binding, Backend backend) {
                    return switch (binding) {
                        case JNI -> JniBindings.of(backend);
                        case FFM -> new FfmBindings(backend);
                    };
                }
