...
#[no_mangle]
pub extern "system" fn Java_dev_sweety_Buffer_process<'a>(
    mut env: JNIEnv<'a>, _class: JClass, buffer: JByteBuffer<'a>, len: jint,
) {
...
#[no_mangle]
pub extern "system" fn Java_dev_sweety_Buffer_free<'a>(
    mut env: JNIEnv<'a>, _class: JClass, buffer: JByteBuffer<'a>,
) {
